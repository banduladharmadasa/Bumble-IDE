...
hyperace.hypersearch.prototype = {
    ...
    _search: function (session, s) {
		...
		if(this.ranges[s].length > 0){
			...
			_link.innerHTML = "<strong>" + found +" hits in " + filePath + " </strong>";
...
function loaded() {
    ...
    var html = "<div id='appendopt' style='cursor:pointer;'> <div id='hyperopt'><span id='execute-on-all-files' class='execute-on-all-files ace_button' title='List All' style='float:right;margin-bottom:2px;padding:0 5px;'>Find in files</span></div> </div>";
